  ...
  return (
    <div>
      ...
      <p className="text-xs text-slate-500 mt-1">
        Select text and click <strong>B</strong> / <em>I</em> / <u>U</u> to format. Press the ¶ button (or Enter twice) to start a new paragraph.
      </p>
      {value.trim() && (
        <div className="mt-2 border border-slate-200 rounded-md p-3 bg-slate-50">
          ...
          <div
            className="text-sm text-slate-700 leading-relaxed [&_p]:mb-2 [&_p:last-child]:mb-0"
